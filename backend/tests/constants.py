...
LIST_VIEW_NAMES = {
    'project': 'api:v1:project-list',
    'test': 'api:v1:test-list',
    'plan': 'api:v1:testplan-list',
    'result': 'api:v1:testresult-list',
    'suite': 'api:v1:testsuite-list',
    'case': 'api:v1:testcase-list',
    'user': 'api:v1:user-list',
    'parameter': 'api:v1:parameter-list',
    'status': 'api:v1:status-list',
}
DETAIL_VIEW_NAMES = {
    'project': 'api:v1:project-detail',
    'test': 'api:v1:test-detail',
    'plan': 'api:v1:testplan-detail',
    'result': 'api:v1:testresult-detail',
    'suite': 'api:v1:testsuite-detail',
    'case': 'api:v1:testcase-detail',
    'user': 'api:v1:user-detail',
    'parameter': 'api:v1:parameter-detail',
    'status': 'api:v1:status-detail',
}
