...
LIST_VIEW_NAMES = {
    ...
    'test-list': 'api:v1:test-list',
    'plan-list': 'api:v1:testplan-list',
    'result-list': 'api:v1:testplan-list',
    'suite-list': 'api:v1:testsuite-list',
...
DETAIL_VIEW_NAMES = {
    ...
    'test-list': 'api:v1:test-detail',
    'plan-list': 'api:v1:testplan-detail',
    'result-list': 'api:v1:testplan-detail',
