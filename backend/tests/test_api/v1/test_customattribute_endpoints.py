...
from testy.core.api.v1.serializers import CustomAttributeOutputSerializer
...
class TestCustomAttributeEndpoints:
    view_name_list = 'api:v1:customattribute-list'
    view_name_detail = 'api:v1:customattribute-detail'
