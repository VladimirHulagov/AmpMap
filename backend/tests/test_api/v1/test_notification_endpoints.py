...
class TestNotificationEndpoints:
    ...
    view_name_enable = 'api:v1:notification-enable'
    view_name_disable = 'api:v1:notification-disable'
    view_name_settings = 'api:v1:notification-settings'
    view_name_mark_as = 'api:v1:notification-mark-as'
