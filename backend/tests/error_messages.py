...
FORBIDDEN_USER_TEST_CASE = 'You can not update version of Test Case'
...
CREATE_RESULT_IN_ARCHIVE_TEST = 'Can not create a result in an archived test'
UPDATE_ARCHIVE_RESULT = 'Can not update result in an archived test/archived result'
