...
class TestParameterModel:
    ...
    def test_unique_together_constraint(self, parameter, parameter_factory, project):
        with pytest.raises(IntegrityError) as err:
            parameter_factory(group_name=parameter.group_name, data=parameter.data, project=project)
