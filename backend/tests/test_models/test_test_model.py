...
class TestTestModel:
    ...
    @pytest.mark.parametrize(
        'parameter_name, incorrect_value, error_type, err_msg', [
            (
                'case', 'abc', ValueError, MODEL_VALUE_ERR_MSG.format(
                    value='abc', model_name='Test', column_name='case',
                    column_model='TestCase',
                ),
            ),
            (
                'plan', 'abc', ValueError, MODEL_VALUE_ERR_MSG.format(
                    value='abc', model_name='Test', column_name='plan',
                    column_model='TestPlan',
                ),
            ),
            (
                'assignee', 'abc', ValueError, MODEL_VALUE_ERR_MSG.format(
                    value='abc', model_name='Test',
                    column_name='assignee', column_model='User',
                ),
            ),
