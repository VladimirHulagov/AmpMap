...
class UserAllowedPermissionCodenames(TextChoices):
    ...
    ADD_ATTACHMENT = 'add_attachment', 'User can add attachments'
    CHANGE_ATTACHMENT = 'change_attachment', 'User can change attachments'
    DELETE_ATTACHMENT = 'delete_attachment', 'User can delete attachments'
    ADD_TEST = 'add_test', 'User can add tests'
    CHANGE_TEST = 'change_test', 'User can change tests'
    DELETE_TEST = 'delete_test', 'User can delete tests'
    ADD_ATTRIBUTE = 'add_customattribute', 'User can add attributes'
    CHANGE_ATTRIBUTE = 'change_customattribute', 'User can change attributes'
    DELETE_ATTRIBUTE = 'delete_customattribute', 'User can delete attributes'
