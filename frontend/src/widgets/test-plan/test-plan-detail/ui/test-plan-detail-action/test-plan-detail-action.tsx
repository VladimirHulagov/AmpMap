...
export const TestPlanDetailAction = memo(({ testPlanId, dataView, setDataView }: Props) => {
  ...
  const handleChangeVisibleColumns = (visibleColumns: ColumnParam[]) => {
    ...
    saveVisibleColumns(`tests-visible-cols-${key}`, visibleColumns)
  }
...
TestPlanDetailAction.displayName = "TestPlanDetailAction"
