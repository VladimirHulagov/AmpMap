...
export const TestSuiteDetailAction = memo(({ dataView, setDataView, suite }: Props) => {
  ...
  const handleChangeVisibleColumns = (visibleColumns: ColumnParam[]) => {
    ...
    saveVisibleColumns(`test-cases-visible-cols-${key}`, visibleColumns)
  }
...
TestSuiteDetailAction.displayName = "TestSuiteDetailAction"
